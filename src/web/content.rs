...
fn supported_media_type_message() -> String {
    format!(
        "Support media types: {}",
    ...
    fn from_data(request: &Request, o: Transformed<'a, Self>) -> Outcome<Self, Self::Error> {
        ...
        if content_type == &ContentType::JSON {
            ...
            Failure((
                ...
                ApiError::UnsupportedMediaType(supported_media_type_message()),
            ))
        }
    }
}
    ...
    fn from_request(request: &'a Request<'r>) -> request::Outcome<Self, Self::Error> {
        ...
        if !supported_types.is_empty() {
            ...
            Failure((
                ...
                ApiError::NotAcceptable(supported_media_type_message()),
            ))
        }
    }
}
